...
public class MusicTask2 {
  ...
  public static void main(String[] args) throws Exception {
	...
	Job job = new Job(conf, "Assignment5_task2");
	job.setJarByClass(MusicTask2.class);
    ...
    job.setMapperClass(MusicTask2Mapper.class);
    job.setReducerClass(MusicTask2Reducer.class);

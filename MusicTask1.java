...
public class MusicTask1 {
  ...
  public static void main(String[] args) throws Exception {
	...
	Job job = new Job(conf, "Assignment5_task1");
	job.setJarByClass(MusicTask1.class);
    ...
    job.setMapperClass(MusicTask1Mapper.class);
    job.setReducerClass(MusicTask1Reducer.class);

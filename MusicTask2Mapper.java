  ...
  extends Mapper<LongWritable, Text, IntWritable, IntWritable> 
{
	...
	{   
		...
		if(Integer.parseInt(lineArray[4])==1)
		{
			...
			t2.set(Integer.parseInt(lineArray[4])); //This will parse the string value into integer and sets the value in t2
			context.write(t1, t2); //This will write the 1st and 2nd  element in string of array as (trackId, heard status)
		}
	}
}
